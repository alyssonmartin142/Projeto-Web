...
public final class produtos_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if (LoginController.estaLogado(request)) { 
      ...
      out.write("            <h1 class=\"w3-center texto-banner\">Produtos!</h1>\n");
      ...
      out.write("                        <th bgcolor=\"#000000\"><font color=\"white\">Comprar</th>\n");
      out.write("                    </tr>\n");
      out.write("                    ");
...
out.print(produtos.get(i).getId());
 ...
 out.print(produtos.get(i).getPrecoUnitario());
      out.write("</td>\n");
      out.write("                        <td><a style=\"text-decoration:none\" href=\"ControleCarrinho?acao=addProduto&idProduto=");
      out.print(produtos.get(i).getId());
      out.write("\">\n");
      out.write("                                <span class=\"glyphicon glyphicon-shopping-cart\" aria-hidden=\"true\"></a></td>\n");
      out.write("                    </tr>\n");
      out.write("                    ");
}
      out.write("\n");
